...
import br.com.smaug.periodictales.World;
import br.com.smaug.periodictales.World.WorldListener;
import br.com.smaug.periodictales.WorldRenderer;
...
public class GameScreen extends ScreenAdapter {
	...
	public GameScreen (PeriodicTales game) {
		this.game = game;
	...
	private void presentLevelEnd () {
		glyphLayout.setText(Assets.font, "O elemento é ...");
		Assets.font.draw(game.batcher, glyphLayout, 160 - glyphLayout.width / 2, 480 - 40);
		glyphLayout.setText(Assets.font, "Próximo elemento!");
